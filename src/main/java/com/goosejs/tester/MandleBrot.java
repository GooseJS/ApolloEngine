...
import static com.goosejs.tester.OpenCLTest.*;
import static com.goosejs.apollo.util.IOUtils.*;
...
import static com.goosejs.apollo.backend.lwjgl.opencl.OpenCLInfoUtils.*;
...
public class MandleBrot {
    ...
    static {
        try {
            source = fileToByteBufferE("Mandlebrot.cl", 4096);
        } catch (IOException e) {
    ...
    public MandleBrot(long platform, CLCapabilities platformCaps, GLFWWindow window, int deviceType, boolean debugGL, int maxIterations) {
